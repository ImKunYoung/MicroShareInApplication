...
import com.sharein.client.service.ClientQueryService;
import com.sharein.client.service.ClientService;
import com.sharein.client.service.criteria.ClientCriteria;
import com.sharein.client.service.dto.ClientDTO;
import com.sharein.client.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.sharein.client.domain.Client}.
 */
@RestController
@RequestMapping("/api")
