...
import com.sharein.client.config.KafkaSseConsumer;
import com.sharein.client.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/clientservice-kafka")
public class ClientserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ClientserviceKafkaResource.class);
    ...
    public ClientserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
