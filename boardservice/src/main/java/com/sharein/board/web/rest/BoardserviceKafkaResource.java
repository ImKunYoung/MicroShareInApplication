...
@RestController
@RequestMapping("/api/boardservice-kafka")
public class BoardserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BoardserviceKafkaResource.class);
    ...
    public BoardserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
