...
import com.sharein.apartment.config.KafkaSseConsumer;
import com.sharein.apartment.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/apartmentservice-kafka")
public class ApartmentserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ApartmentserviceKafkaResource.class);
    ...
    public ApartmentserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
